...
?>
    <div class="scrollbar-inner"><div id="modalContent"></div></div>
<?php Modal::end();?>
...
?>
<div class="scrollbar-inner"><div id="modalContentCancellationPolicy"></div></div>
<?php Modal::end();?>

<?php $this->registerJsFile('/js/cart.js', ['depends' => [JqueryAsset::class]], 'cart-js');?>
<?php $this->registerJs('cart.init()');?>
<?php $this->registerJs('$(".js-popup-cancellation-policy").click(function(){
