...
?>
<div class="fixed">
    <h1 class="mb-5">Cookies Policy</h1>
    <p><em>Last updated: 21/05/2025</em></p>
    ...
    <ul>
        <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to Tripium, LLC.</li>
        <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
        <li><strong>Website</strong> refers to <?= Yii::$app->name ?>, accessible from <a href="https://<?=
            Yii::$app->params['domain'] ?>"><?= Yii::$app->params['domain'] ?></a></li>
    ...
    <ul>
        <li>
            ...
            <div>Purpose: These Cookies are essential to provide You with services available through the Website and to
                ...
                only use these Cookies to provide You with those services.</div>
        </li>
        <li>
            ...
            <div>Purpose: These Cookies allow us to remember choices You make when You use the Website, such as
    ...
    <ul>
        ...
        <li>
            For the Safari web browser, please visit this page from Apple: <a href="https://support.apple.com/guide/safari/manage-cookies-and-website-data-sfri11471/mac" target="_blank">https://support.apple.com/guide/safari/manage-cookies-and-website-data-sfri11471/mac</a>
        </li>
    </ul>
    <p>&nbsp;</p>
    ...
    <p>You can learn more about cookies: <a class="text-white" href="https://www.freeprivacypolicy.com/blog/cookies/"
