...
<div class="calendar-slider-block">
	...
	<div class="week-wrap calendar-slider calendar-slider-in-description">
		...
		<button onclick="return openPopupSchedule(this)" data-href="<?= Url::to(['shows/schedule',
            'code'=>$model->code])?>" class="more-available-dates">
		...
		<div class="ticket-price">
			...
			<link itemprop="url" href="<?= Url::to(['shows/schedule', 'code'=>$model->code])?>">
			<div itemprop="potentialAction" itemscope="" itemtype="https://schema.org/BuyAction">
				<div><button onclick="return openPopupSchedule(this)" rel="nofollow" data-href="<?= Url::to(['shows/schedule', 'code'=>$model->code])?>" class="btn btn-primary" itemprop="target">Buy now</button></div>
			</div>
		</div>
