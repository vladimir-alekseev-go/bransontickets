...
let modification = {
    ...
    open: function (orderNumber, packageNumber, date) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('.show-over-info').removeClass('show-over-info');
                $('.btn-timing').click(function(){
                    $(this).closest('ul').find('li').removeClass('act').removeClass('active');
                    $(this).closest('ul').find('a').removeClass('act');
                    $(this).closest('ul').find('.act-item').removeClass('act-item');
    ...
    getForm: function()
    {
        ...
        let url = "/order/"+_self.order+"/modify/"+_self.packageNumber+"/form/"+_self.date+"/";

        $("#order-form").html('<div class="load-progress"></div>');
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $("input.count:first").trigger("change");
            }
        });
    },
    dataHash: null,
