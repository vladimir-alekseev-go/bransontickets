...
/**
 * This is the model class for table "tr_pos_hotels_categories".
 *
 * @property int $id
 ...
 * @property TrPosHotels $externalShow
 */
class _source_TrPosHotelsCategories extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'tr_pos_hotels_categories';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['id_external_show'], 'exist', 'skipOnError' => true, 'targetClass' => TrPosHotels::class, 'targetAttribute' => ['id_external_show' => 'id_external']],
        ];
    }
    ...
    {
        return $this->hasOne(TrPosHotels::class, ['id_external' => 'id_external_show']);
    }
}
