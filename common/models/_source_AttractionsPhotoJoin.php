...
/**
 * This is the model class for table "attractions_photo_join".
 *
 * @property int $id
 ...
 * @property int $sort
 *
 * @property TrAttractions $item
 * @property ContentFiles $photo
 * @property ContentFiles $preview
 */
class _source_AttractionsPhotoJoin extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['item_id'], 'exist', 'skipOnError' => true, 'targetClass' => TrAttractions::class, 'targetAttribute' => ['item_id' => 'id']],
    ...
    {
        return $this->hasOne(TrAttractions::class, ['id' => 'item_id']);
    }
