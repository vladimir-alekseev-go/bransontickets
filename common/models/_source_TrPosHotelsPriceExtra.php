...
/**
 * This is the model class for table "tr_pos_hotels_price_extra".
 *
 * @property int $id
 ...
 */
class _source_TrPosHotelsPriceExtra extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'tr_pos_hotels_price_extra';
    }
